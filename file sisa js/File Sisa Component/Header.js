            ...
            < header className="u-align-center u-clearfix u-header u-header" id="sec-dce1" >
                <div className="u-clearfix u-sheet u-valign-middle-sm u-valign-middle-xs u-sheet-1">
                    ...
                    <div
                        ...
                        <ol className="u-absolute-hcenter u-carousel-indicators u-carousel-indicators-1">
                            ...
                            <li data-u-target="#carousel-80dd" data-u-slide-to="1" className="u-grey-70 u-shape-circle"
                                style={{ width: "10px;", height: "10px;" }}></li>
                        </ol>
                        {/* <!-- Gambar Slider  --> */}
                        <div className="u-carousel-inner u-gallery-inner" role="listbox">
                            ...
                            <div className="u-carousel-item u-effect-fade u-gallery-item u-carousel-item-2">
                                <div className="u-back-slide" data-image-width="500" data-image-height="500">
                                    <img className="u-back-image u-expanded" src="images/WhatsAppImage2021-03-09at21.28.38.jpeg" />
                                </div>
                ...
                <nav className="u-align-left u-menu u-menu-dropdown u-offcanvas u-menu-1" data-responsive-from="MD"
                    ...
                    <div className="menu-collapse u-custom-font"
                        style={{ fontSize: "1rem;", letterSpacing: "0px;", fontFamily: "Lato;", fontWeight: "900;" }}>            <a className="u-button-style u-custom-color u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base"
                            href="#">
                            {/* Masukkan CSS hamburger ke responsive tiap halaman */}
                            <i className="fas fa-bars hamburger-respon">
                        ...
                        <div className="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                            <div className="u-inner-container-layout u-sidenav-overflow">
                                ...
                                <ul className=" u-nav u-popupmenu-items u-unstyled u-nav-2">
                                    ...
                                    <li className="u-nav-item"><a className="u-button-style u-nav-link" href="/Sale"
