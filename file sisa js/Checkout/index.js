...
export default function Home() {
    return (
        <>
            <link rel="stylesheet" href="/css/Form-Data-Penerima(Konsumen).css" media="screen"></link>
            <LayoutSlider>
                        ...
                        <div className="u-form u-form-1">
                            <form action="#" method="POST" className="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style={{ padding: "10px" }}>
                                <div className="u-form-group u-form-name">
                                    <label htmlFor="name-4793" className="u-form-control-hidden u-label"></label>
                                ...
                                <div className="u-form-group u-form-phone u-form-group-2">
                                    <label htmlFor="phone-36c7" className="u-form-control-hidden u-label"></label>
                                ...
                                <div className="u-form-address u-form-group u-form-group-3">
                                    <label htmlFor="address-2dd0" className="u-form-control-hidden u-label"></label>
                                ...
                                <div className="u-form-email u-form-group">
                                    <label htmlFor="email-4793" className="u-form-control-hidden u-label"></label>
