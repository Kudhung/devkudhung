...
const Kirim = ({ dataSlider }) => {
    return (
        <>

            <link rel="stylesheet" href="/css/Dikirim.css" media="screen" />
            ...
            >
                <section className="u-clearfix u-section-1" id="sec-767a">
                                ...
                                <div className="u-layout-row">
                                    <div className="u-container-style u-layout-cell u-opacity u-opacity-60 u-size-60 u-white u-layout-cell-8">
                                        <div className="u-border-1 u-border-grey-75 u-container-layout u-container-layout-13">
                                            ...
                                            <a href="https://nicepage.best" className="u-btn u-btn-round u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-6 u-btn-2">Barang Sudah Sampai</a>
                                            <p className="u-small-text u-text u-text-default u-text-variant u-text-11">Barang akan sampai sebelum tanggal <span className="u-text-palette-2-base">12-12-2022</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
