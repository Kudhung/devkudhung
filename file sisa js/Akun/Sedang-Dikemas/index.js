...
export default function SedangDikemas({ dataSlider }) {
    return (
        <>
            <link rel="stylesheet" href="/css/Dikemas.css" media="screen"></link>
                        ...
                        <div className="u-layout-row">
                            <div className="u-container-style u-layout-cell u-opacity u-opacity-60 u-size-60 u-white u-layout-cell-8">
                                <div className="u-border-1 u-border-grey-75 u-container-layout u-container-layout-13">
                                    ...
                                    <p className="u-small-text u-text u-text-default u-text-variant u-text-11">Pesanan akan dikirim sebelum tangal <span className="u-text-palette-2-base">12-12-2022</span>
                                    </p>
                                </div>
                            </div>
                        </div>
